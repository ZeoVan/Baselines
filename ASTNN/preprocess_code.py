...
def generate_fulltree(ast_root):
    """
    Given a concretised & numbered clang ast, return the full tree
    in the form:
        [
            [<start_node_id>, <end_node_id>],
            ...
...
def process_for_subtree(testcase, **kwargs):
    """
    Takes in a list of files/datapoints from juliet.csv.zip or
    vdisc_*.csv.gz (as loaded with pandas) matching one particular
    testcase, and preprocesses it ready for the baseline model.
    ...
    #number_ast_nodes(ast_root)
    print(ast_root.kind)
    # TODO // walk through the tree to get the full tree nodes
    return ast_root
...
if __name__=="__main__":
    ...
    print("# Welcome ---------------------------------- #\n"
          "Loaded i the first datapoint from juliet, and \n"
